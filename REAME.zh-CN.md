...
自托管指取代 SasS 提供服务而使用本地运行和管理程序的方式。

这个列表是免费软件服务和 web 程序, 并且可以运行在本地。 非自由软件列表查看这个页面。

查看贡献列表。

- 软件列表
  - [分析](#analytics)
  - [存档和数据保存](#archiving-and-digital-preservation-dp)
  - [自动化](#automation)
  - [博客平台](#blogging-platforms)
  - [书签和连接分享](#bookmarks-and-link-sharing)
  - [日历与联系人管理](#calendaring-and-contacts-management)
  - [通信系统](#communication-systems)
    - [自定义通信系统](#custom-communication-systems)
    - [邮件](#email)
    ...
    - [SIP](#sip)
    - [IPBX](#ipbx)
    - [社交网络和论坛](#social-networks-and-forums)
    - [XMPP](#xmpp)
  ...
  - [软件开发](#software-development)
    ...
    - [文档生成](#documentation-generators)
    - [Localization](#localization)
  - [静态网站生成](#static-site-generators)
  - [任务管理/To-do 列表](#task-managementto-do-lists)
  - [Ticketing](#ticketing)
  - [URL 短链接](#url-shorteners)
  - [VPN](#vpn)
  - [Web 服务](#web-servers)
  - [维基](#wikis)
- [自托管方案](#self-hosting-solutions)
...
## 分析
个人分析/操作面板, 查看 [Personal Dashboards](https://github.com/Kickball/awesome-selfhosted#personal-dashboards)

**[`^        回到顶部        ^`](#)**

_Web 分析_

- [AWStats](http://www.awstats.org/) -  网站日志图形化分析工具. ([Source Code](https://github.com/eldy/awstats)) `GPL-3.0` `Perl`
- [Countly](https://count.ly) - 移动端/web端 实时分析，崩溃报告，推送通知平台.  ([Source Code](https://github.com/countly)) `AGPL-3.0` `Javascript`
- [Druid](http://druid.io/) - 分布式，面向列的实时数据存储分析. ([Source Code](https://github.com/druid-io/druid/)) `Apache-2.0` `Java`
- [Fathom Analytics](https://usefathom.com) - 简单而真实的网站分析。 ([Source Code](https://github.com/usefathom/fathom)) `MIT` `Go`
- [GoAccess](http://goaccess.io/) - 实时 web 日志分析, 且在终端集成数据查看。 ([Source Code](https://github.com/allinurl/goaccess)) `GPL-2.0` `C`
...
- [Redash](http://redash.io) - 可连接 18 种数据库类型 (SQL and "NoSQL"), 查询数据, 可视化和操作面板. 通过 URL 分析结果. Slack 和 HipChat 集成. ([Demo](https://demo.redash.io), [Source Code](https://github.com/getredash/redash)) `BSD-2-Clause` `Python`
- [Superset](http://superset.apache.org/) - 现代的企业级商业智能 Web 程序. ([Source Code](https://github.com/apache/incubator-superset)) `Apache-2.0` `Python`
